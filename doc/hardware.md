...
* A raspberry PI 3 (or similar or above).  In fact I'm doing most of the development on my linux desktop computer and won't switch back to using a pi for a couple of weeks.
